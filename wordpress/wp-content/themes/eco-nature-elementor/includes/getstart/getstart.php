...
?>
    ...
    <div class="inner-cont">
	    <div class="tab-sec">
	    	<div class="tab">
				<button class="tablinks" onclick="eco_nature_elementor_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Setup With Elementor', 'eco-nature-elementor' ); ?></button>
			...
			<div id="wpelemento_importer_editor" class="tabcontent open">
				...
				<?php }else{ ?>
					<div class="tab-outer-box">
						<h3><?php esc_html_e('Welcome to WPElemento Theme!', 'eco-nature-elementor'); ?></h3>
						<p><?php esc_html_e('Click on the quick start button to import the demo.', 'eco-nature-elementor'); ?></p>
						<div class="info-link">
							<a  href="<?php echo esc_url( admin_url('admin.php?page=wpelementoimporter-wizard') ); ?>"><?php esc_html_e('Quick Start', 'eco-nature-elementor'); ?></a>
						</div>
					</div>
				<?php } ?>
			</div>
		...
		<div class="inner-side-content">
			...
			<div class="tab-outer-box">
				...
				<div class="iner-sidebar-pro-btn">
					<span class="premium-btn"><a href="<?php echo esc_url( ECO_NATURE_ELEMENTOR_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Premium', 'eco-nature-elementor'); ?></a>
					</span>
					...
					<span class="doc-btn"><a href="<?php echo esc_url( ECO_NATURE_ELEMENTOR_THEME_BUNDLE ); ?>" target="_blank"><?php esc_html_e('Theme Bundle', 'eco-nature-elementor'); ?></a>
					</span>
				</div>
				<hr>
