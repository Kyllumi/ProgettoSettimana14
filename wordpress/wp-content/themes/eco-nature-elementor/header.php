		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-md-4 col-sm-4">
					<?php if ( get_theme_mod('eco_nature_elementor_header_advertisement_text') ) : ?>
						<p class="mb-0"><?php echo esc_html( get_theme_mod('eco_nature_elementor_header_advertisement_text' ) ); ?></p>
					<?php endif; ?>
				</div>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 text-center text-md-right">
					<?php if ( get_theme_mod('eco_nature_elementor_header_email') ) : ?>
						<a href="mailto:<?php echo esc_url( get_theme_mod('eco_nature_elementor_header_email' ) ); ?>"><p class="mb-0"><?php echo esc_html( get_theme_mod('eco_nature_elementor_header_email' ) ); ?></p></a>
					<?php endif; ?>
				</div>
			</div>
		</div>
					...
					<div class="logo text-center text-lg-left mb-3 mb-lg-0">
						...
						<div class="logo-content">
							<?php
								...
								if ( get_theme_mod('eco_nature_elementor_display_header_text', false) == true ) :
							...
							<div class="social-links text-center text-md-right">
								<?php if ( is_array($eco_nature_elementor_settings) || is_object($eco_nature_elementor_settings) ){ ?>
							    	<?php foreach( $eco_nature_elementor_settings as $eco_nature_elementor_setting ) { ?>
								        <a href="<?php echo esc_url( $eco_nature_elementor_setting['link_url'] ); ?>" target="_black">
							...
							<?php if ( get_theme_mod('eco_nature_elementor_header_phone_number') || get_theme_mod('eco_nature_elementor_header_phone_number_text') ) : ?>
								<div class="row header-icon">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 col-9 align-self-center">
										...
										<a href="tel:<?php echo esc_url( get_theme_mod('eco_nature_elementor_header_phone_number' ) ); ?>"><h6 class="mb-0"><?php echo esc_html( get_theme_mod('eco_nature_elementor_header_phone_number' ) ); ?></h6></a>
									</div>
								</div>
							<?php endif; ?>
						</div>
			...
			<div class="center-header-box">
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-6 px-md-0 align-self-center">
						<?php if ( get_theme_mod('eco_nature_elementor_search_enable', 'on' ) == true ) : ?>
