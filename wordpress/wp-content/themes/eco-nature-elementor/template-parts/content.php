...
?>
<?php if ((get_theme_mod( 'eco_nature_elementor_post_layout','Right Sidebar') == 'Three Columns') || (get_theme_mod( 'eco_nature_elementor_post_layout','Right Sidebar') == 'Four Columns')) : ?> 
