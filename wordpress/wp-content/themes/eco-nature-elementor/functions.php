	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			...
			echo '<div class="notice-content">';
				echo '<h2>'. esc_html__( 'Welcome to WPElemento', 'eco-nature-elementor' ) .'</h2>';
				echo '<p>'. esc_html__( 'Thank you for choosing Eco Nature Elementor theme .To setup the theme, please visit the get started page.', 'eco-nature-elementor' ) .'</p>';
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=eco_nature_elementor_about' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'eco-nature-elementor' ) .'</a></span>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
}
...
if (!function_exists('eco_nature_elementor_widgets_init')) {
	...
	function eco_nature_elementor_widgets_init() {
		...
		register_sidebar(array(
			...
			'description'   => esc_html__('This sidebar will be shown on blog pages.', 'eco-nature-elementor'),
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Page Sidebar','eco-nature-elementor'),
			'id'   => 'sidebar-2',
			'description'   => esc_html__('This sidebar will be shown on pages.', 'eco-nature-elementor'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar three','eco-nature-elementor'),
			'id'   => 'sidebar-3',
			'description'   => esc_html__('This sidebar will be shown on blog pages.', 'eco-nature-elementor'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 1','eco-nature-elementor'),
			'id'   => 'footer1-sidebar',
			'description'   => esc_html__('It appears in the footer 1.', 'eco-nature-elementor'),
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 2','eco-nature-elementor'),
			'id'   => 'footer2-sidebar',
			'description'   => esc_html__('It appears in the footer 2.', 'eco-nature-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 3','eco-nature-elementor'),
			'id'   => 'footer3-sidebar',
			'description'   => esc_html__('It appears in the footer 3.', 'eco-nature-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 4','eco-nature-elementor'),
			'id'   => 'footer4-sidebar',
			'description'   => esc_html__('It appears in the footer 4.', 'eco-nature-elementor'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
...
function eco_nature_elementor_logo_resizer() {

    $eco_nature_elementor_theme_logo_size_css = '';
    $eco_nature_elementor_logo_resizer = get_theme_mod('eco_nature_elementor_logo_resizer');

	$eco_nature_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($eco_nature_elementor_logo_resizer).'px !important;
			width: '.esc_attr($eco_nature_elementor_logo_resizer).'px !important;
		}
	';
    wp_add_inline_style( 'eco-nature-elementor-style',$eco_nature_elementor_theme_logo_size_css );

}
add_action( 'wp_enqueue_scripts', 'eco_nature_elementor_logo_resizer' );
...
function eco_nature_elementor_customize_css() {
	?>
	<?php if ( 'right' == get_theme_mod( 'eco_nature_elementor_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale {
			left: auto; right: 10px;
		}
		</style>
	<?php elseif ( 'left' == get_theme_mod( 'eco_nature_elementor_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale{
...
add_action( 'wp_head', 'eco_nature_elementor_customize_css');
...
define('ECO_NATURE_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','eco-nature-elementor'));
